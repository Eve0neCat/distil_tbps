# 预训练微调
# tinyclip_yfcc15m_xsmall： vision 10L width 256, text 3L width 256 layer, embedding_dim=512,
```
python distillation/distillation_train.py \
--name tinyclip_yfcc15m_xsmall_model-task_itc \
--img_aug \
--batch_size 64 \
...
>./logs/RSTPReid/training1.log 2>&1 &
...
--teacher_model_config "logs/ICFG-PEDES/20241209_125857_iira/configs.yaml" \
--pretrain_student_choice 'state_dict_pretrain_model/tinyclip_yfcc15m_xsmall.pth' \
>./logs/ICFG-PEDES/training4.log 2>&1 &
...
--distillation_config_path "distillation/distillation_xsmall/sequence_ditillation_tinyclip_yfcc15m_xsmall_ab_MoTIS_loss.json" \
...
--teacher_model_config "logs/ICFG-PEDES/20241209_125857_iira/configs.yaml" \
--pretrain_student_choice 'state_dict_pretrain_model/tinyclip_yfcc15m_xsmall.pth' \
>./logs/ICFG-PEDES/training7.log 2>&1 &
...
```
python distillation/sequence_distillation_train.py \
--name sequence_tinyclip_yfcc15m_xsmall-dist_ab_ours_loss1-task_itc \
--img_aug \
--batch_size 64 \
...
--distillation_inter_ss_kl_temperature 0.5 \
--distillation_inter_ts_sym_kl_temperature 0.5 \
--distillation_config_path "distillation/distillation_xsmall/sequence_ditillation_tinyclip_yfcc15m_xsmall_ab_ours_loss1.json" \
--teacher_model_config "logs/CUHK-PEDES/20241202_201442_iira/configs.yaml" \
--pretrain_student_choice 'state_dict_pretrain_model/tinyclip_yfcc15m_xsmall.pth' \
>./logs/CUHK-PEDES/training3.log 2>&1 &
