...
from utils.metrics import Evaluator, Sequence_Distillation_Evaluator, Sequence_Distillation_Evaluator2
...
from distillation_processor import do_train_sequence_distillation_MoTIS_2s, do_train_sequence_distillation_MoTIS_3s
...
if __name__ == '__main__':
    ...
    if student_config.sequence_distillation_2stages:
        do_train_sequence_distillation_MoTIS_2s(start_epoch, student_model, student_config, 
                        train_loader, evaluator, optimizer, scheduler, 
                        checkpointer, logger,
                        teacher_model, teacher_config, project)
    elif student_config.sequence_distillation_3stages:
        do_train_sequence_distillation_MoTIS_3s(start_epoch, student_model, student_config, 
                        train_loader, evaluator, optimizer, scheduler, 
                        checkpointer, logger,
                        teacher_model, teacher_config, project)
    elif student_config.distillation:
